...
class F_RandomProj(nn.Module):
    ...
    def forward(self, x):
        ...
        if self.d_pos == 'first':
            out['0'] = out['0'] + self.diffusion.p * self.diffusion(out['0'], noise_std=self.noise_sd)
            out['1'] = out['1'] + self.diffusion.p * self.diffusion(out['1'], noise_std=self.noise_sd)
            out['2'] = out['2'] + self.diffusion.p * self.diffusion(out['2'], noise_std=self.noise_sd)
            out['3'] = out['3'] + self.diffusion.p * self.diffusion(out['3'], noise_std=self.noise_sd)
        ...
        out0_channel_mixed = out0_channel_mixed 
        out1_channel_mixed = out1_channel_mixed 
        out2_channel_mixed = out2_channel_mixed 
        out3_channel_mixed = out3_channel_mixed 
        ...
        out0_scale_mixed = out0_scale_mixed 
        out1_scale_mixed = out1_scale_mixed 
        out2_scale_mixed = out2_scale_mixed 
        out3_scale_mixed = out3_scale_mixed 
